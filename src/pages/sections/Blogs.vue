        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <card type="blog" plain>
              ...
              >More acquisitions for Groupon to widen the net of consumers using its platform for more than daily deals. Today it is announcing the acquisition of ideeli, a flash fashion retailer, for $43 million in...</h5>
            ...
            <card type="blog" plain>
              ...
              <h5
                class="card-description"
              >Some might say that technology is killing the music industry. But if you look around, there’s a beautiful marriage there — the music industry is evolving every day, and artists are embracing technology in new and innovative ways...</h5>
              <a href="#pablo" class="btn btn-primary btn-round">Read More</a>
            </card>
          </div>
        </div>
              ...
              <div class="col-md-4">
                <div class="card card-blog">
                  ...
                  <div class="card-body">
                    ...
                    <h5 class="card-title">That’s One Way To Ditch Your Passenger</h5>
                    <p
                      class="card-description"
                    >As near as we can tell, this guy must have thought he was going over backwards and tapped the rear...</p>
              ...
              <div class="col-md-4">
                <div class="card card-blog">
                  ...
                  <div class="card-body">
                    ...
                    <h5 class="card-title">Shark Week: How to Watch It Like a Scientist</h5>
                    <p
                      class="card-description"
                    >Just when you thought it was safe to turn on your television, the Discovery Channel's "Shark Week"...</p>
                    <div class="card-footer">
                      <div class="author">
                        <img v-lazy="'img/julie.jpg'" alt="..." class="avatar img-raised" />
                        <span>Mike John</span>
              ...
              <div class="col-md-4">
                <div class="card card-blog">
                  ...
                  <div class="card-body">
                    ...
                    <h5 class="card-title">Who's Afraid of the Self-Driving Car?</h5>
                    <p
                      class="card-description"
                    >It's been 60 years since the cover of Popular Mechanics magazine gave us the promise of flying cars...</p>
                    <div class="card-footer">
                      <div class="author">
                        <img v-lazy="'img/olivia.jpg'" alt="..." class="avatar img-raised" />
