        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <card type="pricing" color="orange">
              ...
              <a href="#pablo" class="btn btn-neutral btn-primary disabled btn-round">Current Plan</a>
            </card>
          </div>
          <div class="col-md-4">
            <card type="pricing" plain>
              ...
              <a href="#pablo" class="btn btn-warning btn-round">Upgrade Plan</a>
            </card>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <p class="description">
              ...
              also have 20 days to request a refund if you're not happy with your purchase.
            </p>
          </div>
