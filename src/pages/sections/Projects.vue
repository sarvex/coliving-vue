        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            ...
            <tabs type="danger" centered pills>
              ...
              <tab-pane label="Fiction"></tab-pane>
            </tabs>
          </div>
        </div>
        <div class="row">
              ...
              <div class="card-body">
                <div class="card-title text-left">
                  <h2>
                    <a
                      href="#pablo"
                    >The “crazy idea that could lead to a big future commission” project.</a>
                  </h2>
                </div>
              ...
              <div class="card card-fashion arrow-left">
                <div class="card-title">
                  <h4>
                    <a
                      href="#pablo"
                    >The elements of Agile Project Management have been around for decades...</a>
                  </h4>
                </div>
                <div class="card-body">
                  <div class="card-footer">
