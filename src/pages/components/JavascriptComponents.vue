<template>
  <div class="section section-javascript" id="javascriptComponents">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="datepicker-container">
                ...
                <fg-input>
                  <el-time-select placeholder="Time Picker" v-model="pickers.timePicker"></el-time-select>
                </fg-input>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <p class="description">
                ...
                <a href="https:///www.creative-tim.com/">Creative Tim</a>. You can choose a social
                network or
    ...
    <modal :show.sync="modals.login" modal-classes="modal-login" class="modal-primary">
